...
extern "C" {
#endif
// Re-define to use our versions of uart.
#define uart_driver_install myuart_driver_install
#define uart_driver_delete myuart_driver_delete
#define uart_is_driver_installed myuart_is_driver_installed
#define uart_set_word_length myuart_set_word_length
#define uart_get_word_length myuart_get_word_length
#define uart_set_stop_bits myuart_set_stop_bits
#define uart_get_stop_bits myuart_get_stop_bits
#define uart_set_parity myuart_set_parity
#define uart_get_parity myuart_get_parity
#define uart_get_sclk_freq myuart_get_sclk_freq
#define uart_set_baudrate myuart_set_baudrate
#define uart_get_baudrate myuart_get_baudrate
#define uart_set_line_inverse myuart_set_line_inverse
#define uart_set_hw_flow_ctrl myuart_set_hw_flow_ctrl
#define uart_set_sw_flow_ctrl myuart_set_sw_flow_ctrl
#define uart_get_hw_flow_ctrl myuart_get_hw_flow_ctrl
#define uart_clear_intr_status myuart_clear_intr_status
#define uart_enable_intr_mask myuart_enable_intr_mask
#define uart_disable_intr_mask myuart_disable_intr_mask
#define uart_enable_rx_intr myuart_enable_rx_intr
#define uart_disable_rx_intr myuart_disable_rx_intr
#define uart_disable_tx_intr myuart_disable_tx_intr
#define uart_enable_tx_intr myuart_enable_tx_intr
#define uart_isr_register myuart_isr_register
#define uart_isr_free myuart_isr_free
#define uart_set_pin myuart_set_pin
#define uart_set_rts myuart_set_rts
#define uart_set_dtr myuart_set_dtr
#define uart_set_tx_idle_num myuart_set_tx_idle_num
#define uart_param_config myuart_param_config
#define uart_intr_config myuart_intr_config
#define uart_wait_tx_done myuart_wait_tx_done
#define uart_tx_chars myuart_tx_chars
#define uart_write_bytes myuart_write_bytes
#define uart_write_bytes_with_break myuart_write_bytes_with_break
#define uart_read_bytes myuart_read_bytes
#define uart_flush myuart_flush
#define uart_flush_input myuart_flush_input
#define uart_get_buffered_data_len myuart_get_buffered_data_len
#define uart_get_tx_buffer_free_size myuart_get_tx_buffer_free_size
#define uart_disable_pattern_det_intr myuart_disable_pattern_det_intr
#define uart_enable_pattern_det_baud_intr myuart_enable_pattern_det_baud_intr
#define uart_pattern_pop_pos myuart_pattern_pop_pos
#define uart_pattern_get_pos myuart_pattern_get_pos
#define uart_pattern_queue_reset myuart_pattern_queue_reset
#define uart_set_mode myuart_set_mode
#define uart_set_rx_full_threshold myuart_set_rx_full_threshold
#define uart_set_tx_empty_threshold myuart_set_tx_empty_threshold
#define uart_set_rx_timeout myuart_set_rx_timeout
#define uart_get_collision_flag myuart_get_collision_flag
#define uart_set_wakeup_threshold myuart_set_wakeup_threshold
#define uart_get_wakeup_threshold myuart_get_wakeup_threshold
#define uart_wait_tx_idle_polling myuart_wait_tx_idle_polling
#define uart_set_loop_back myuart_set_loop_back
#define uart_set_always_rx_timeout myuart_set_always_rx_timeout
