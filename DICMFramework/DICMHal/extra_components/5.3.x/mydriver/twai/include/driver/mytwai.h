...
extern "C" {
#endif
// Re-define to use our versions of twai.
#define twai_driver_install mytwai_driver_install
#define twai_driver_install_v2 mytwai_driver_install_v2
#define twai_driver_uninstall mytwai_driver_uninstall
#define twai_driver_uninstall_v2 mytwai_driver_uninstall_v2
#define twai_driver_resume mytwai_driver_resume
#define twai_driver_pause mytwai_driver_pause
#define twai_start mytwai_start
#define twai_start_v2 mytwai_start_v2
#define twai_stop mytwai_stop
#define twai_stop_v2 mytwai_stop_v2
#define twai_transmit mytwai_transmit
#define twai_transmit_v2 mytwai_transmit_v2
#define twai_receive mytwai_receive
#define twai_receive_v2 mytwai_receive_v2
#define twai_read_alerts mytwai_read_alerts
#define twai_read_alerts_v2 mytwai_read_alerts_v2
#define twai_reconfigure_alerts mytwai_reconfigure_alerts
#define twai_reconfigure_alerts_v2 mytwai_reconfigure_alerts_v2
#define twai_initiate_recovery mytwai_initiate_recovery
#define twai_initiate_recovery_v2 mytwai_initiate_recovery_v2
#define twai_reconfigure_alerts mytwai_reconfigure_alerts
#define twai_reconfigure_alerts_v2 mytwai_reconfigure_alerts_v2
#define twai_get_status_info mytwai_get_status_info
#define twai_get_status_info_v2 mytwai_get_status_info_v2
#define twai_clear_transmit_queue mytwai_clear_transmit_queue
#define twai_clear_transmit_queue_v2 mytwai_clear_transmit_queue_v2
#define twai_clear_receive_queue mytwai_clear_receive_queue
#define twai_clear_receive_queue_v2 mytwai_clear_receive_queue_v2
...
/**
 * @brief   Resume the TWAI driver
 *
 * Acquires the APB frequency lock.
 */
void twai_driver_resume(void);

/**
 * @brief   Pause the TWAI driver
 *
 * Releases the APB frequency lock and allows the system to enter light sleep mode.
 */
void twai_driver_pause(void);
...
void get_print_twai_bus_error(void);
#ifdef __cplusplus
}
#endif
