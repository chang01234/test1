...
#define SPI_DEFAULT_BUFFER_LENGTH       64  /* in half-duplex mode, ESP32 prohibits you from transmitting and receiving data longer than 64 bytes */  

// Maximum number of data bytes in message
#define MCP2518FD_MAX_DATA_BYTES        SPI_DEFAULT_BUFFER_LENGTH
#define MCP2518FD_MAX_MSG_SIZE          SPI_DEFAULT_BUFFER_LENGTH

#define MCP2518FD_TX_RX_OBJ_HDR_BYTES     8  
#define MCP2518FD_CAN_2_0_MAX_BYTES       8
...
typedef struct _CAN_ERROR_STATS{
