 ...
 *
 * Generated on Fri Jan 19 11:40:42 2018
 ...
 *
 * The crc32_init() function returns the inital \c crc value and must be called
...
/* Get CRC32 of provided buffer */
static inline crc32_t crc32_get(const void *data, size_t data_len)
{
    return crc32_update(0xFFFFFFFFUL, data, data_len) ^ 0xFFFFFFFFUL;
}

/* Self-test (debug/unit testing) */
