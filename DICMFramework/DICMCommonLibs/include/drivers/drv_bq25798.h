 ...
 *
 *****************************************************************************/
#ifndef DRV_BQ25798_H_
#define DRV_BQ25798_H_
...
//!<BQ25798_IC
#define BQ25798_CHIP_NAME                       "BQ25798"
#define BQ25798_PART_NUMBER                     3u
#define BQ25798_DEV_NUMBER                      1u
#define DEV_PMIC_BQ25798_I2C_SLAVE_ADDR         0x6B

#define ARR_ELEMENTS(x)					        (sizeof(x) / sizeof(x[0]))	//!< \~ Element count of array
#define BQ25798_REGISTER_SIZE_IN_BYTES          1u

#define BQ25798_REG18_TS_COOL_BIT_CLEAR         0xC0
#define BQ25798_REG18_TS_WARM_BIT_CLEAR         0x30

#define BQ25798_REG18_TS_COOL_71_1              0x00
#define BQ25798_REG18_TS_COOL_68_4              0x40
#define BQ25798_REG18_TS_COOL_65_5              0x80
#define BQ25798_REG18_TS_COOL_62_4              0xC0

#define BQ25798_REG18_TS_WARM_48_4              0x00
#define BQ25798_REG18_TS_WARM_44_8              0x10
#define BQ25798_REG18_TS_WARM_41_2              0x20
#define BQ25798_REG18_TS_WARM_37_7              0x30



#define BQ25798_REG16_TREG_BIT_CLEAR           0xC0
#define BQ25798_REG16_TSHUT_BIT_CLEAR          0x30 
#define BQ25798_REG16_TSHUT_85C                0x30
#define BQ25798_REG16_TREG_65C                 0x00

#define CURRENT_LIMIT_REG_BIT_STEP_SIZE_MILLI_AMP   10
#define BQ25798_BATTERY_CHARGE_CURRENT              50                  // 50       *      10        +    0       =  500 mA
#define BQ25798_BATTERY_LIMITED_CURRENT             10                  // 10       *      10        +    0       =  100 mA
...
/*MPPT Feature */
#define ENABLE_MPPT                                 0xAB
#define DISABLE_MPP                                 0xAA 
...
#define MINIMUM_SYSTEM_VOLTAGE_VALUE        39              // 39        *      250       +   2500     =  9750 + 2500 = 12250 (12.50 Volt)
...
typedef enum __bq25798_reg_addr
{
    ...
    MPPT_CONTROL_REG15H           = 0x15,
#else
    RESERVED_REG15H               = 0x15,
#endif
...
typedef union
{
	...
	struct 
	{
		uint8_t B0_DIS_FWD_OOA : 1;
        uint8_t B1_DIS_OTG_OOA : 1;
        uint8_t B2_DIS_LDO : 1;
        uint8_t B3_WKUP_DLY : 1;
        uint8_t B4_PFM_FWD_DIS : 1;
        uint8_t B5_PFM_OTG_DIS : 1;
        uint8_t B6_EN_OTG : 1;
        uint8_t B7_DIS_ACDRV : 1;
	} __attribute__((packed));
}REG12_CHARGER_CTRL_3;
...
//!< Structure to initiaize the BQ25798 driver 
typedef struct __bq25798_reg_config
{
    bq25798_reg_addr     addr;
    uint8_t*             data;
}bq25798_reg_config;

//!< struct type for I2C bus configration
typedef struct drv_i2c_conf
{
    uint8_t  port;
    uint32_t sda;
    uint32_t scl;
