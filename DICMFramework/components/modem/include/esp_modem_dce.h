 ...
 *
 */
#define MODEM_COMMAND_TIMEOUT_DEFAULT (3000)     /*!< Default timeout value for most commands */
...
struct modem_dce {
    ...
    esp_err_t (*get_netw_status)(modem_dce_t *dce, uint32_t *result_code, uint32_t *status); /*!< +CREG? */
};
