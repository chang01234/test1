...
#ifndef SIMULATOR_HMI_CFXX_H_
#define SIMULATOR_HMI_CFXX_H_

#include "software_simulator.h"

#define SIMULATOR_HMI                       g__class_hmi_cfxx_descriptor

extern const SOFTWARE_SIMULATOR__DESCRIPTOR g__class_hmi_cfxx_descriptor;

#endif /* SIMULATOR_HMI_CFXX_H_ */