 ...
 * \brief       Simulator for IV DDM2 class - variant `full climate` implementation
 *
 * Implementation of tables to simulate IV DDM2 class - variant `full climate`
 *
...
static const struct ddm_store_ddm s__ddm_initial_values[] =
{
	...
	},
	{
		...
		.value =
		{
			.storage = { .i32 = IV0STORAGE_ACTIVATE },
			.type = DDM2_TYPE_INT32_T
		}
	},
	{
	...
	},
	{
		...
		.value =
		{
			.storage = { .i32 = IV0WARN_NO_WARNING },
			.type = DDM2_TYPE_INT32_T
		}
	},
	{
		...
		.value =
		{
			.storage = { .i32 = IV0PWRSRC_12V_CAR_BATTERY_INPUT },
			.type = DDM2_TYPE_INT32_T
		}
	},
};
...
const SOFTWARE_SIMULATOR__DESCRIPTOR g__class_iv_full_climate_descriptor =
{
...
#endif /* SOFTWARE_SIMULATOR_FULL_CLIMATE */
