 ...
 * \brief       Simulator for HMI DDM2 class - variant `none` implementation
 *
 * Implementation of tables to simulate HMI DDM2 class - variant `none`
 *
...
static const struct ddm_store_ddm s__ddm_owned_initial_values[] = {
    ...
    {.ddm_parameter = HMI0VER, .value = {.storage = {.str = "1"}, .type = DDM2_TYPE_STRING}},
...
const SOFTWARE_SIMULATOR__DESCRIPTOR g__class_hmi_none_descriptor = {
