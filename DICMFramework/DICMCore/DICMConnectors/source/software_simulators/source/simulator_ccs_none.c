 ...
 * \brief       Simulator for CCS DDM2 class - variant `none` implementation
 *
 * Implementation of tables to simulate CCS DDM2 class - variant `none`
 *
...
const SOFTWARE_SIMULATOR__DESCRIPTOR g__class_ccs_none_descriptor =
{
