 ...
 * specifc macro in this header file: LOAD_CONFIGURATIONS__DESCRIPTOR_SMART_ECO_RULE_ENGINE
 * 
 * Example:
 *  configuration.h
 *      #define LOAD_CONFIGURATIONS
 *      #define LOAD_CONFIGURATIONS__SMART_ECO_RULE_ENGINE_CONFIGURATION
 * 
...
#ifndef LOAD_CONFIGURATIONS__SMART_ECO_RULE_ENGINE_H
#define LOAD_CONFIGURATIONS__SMART_ECO_RULE_ENGINE_H

#include "load_configurations.h"

#define LOAD_CONFIGURATIONS__DESCRIPTOR_SMART_ECO_RULE_ENGINE
#define LOAD_CONFIGURATIONS__DESCRIPTOR_SMART_ECO_RULE_ENGINE_NAME smart_eco_rule_engine__descriptor

extern const struct load_configurations__descriptor smart_eco_rule_engine__descriptor;

#endif //LOAD_CONFIGURATIONS__SMART_ECO_RULE_ENGINE_H
