...
#define NMEA2K_MAX_NUMBER_PACKET_BEFOFE_CTS 8      // 3, Maximum number of Packet that can be received
...
#define DGN_STANDARD_MSG_TX_READY 4
#define DGN_MP_MSG_TX_READY       5
//------------------------------------------------------------------------------
// Public types
//------------------------------------------------------------------------------
...
typedef void (*dgn_tx_ready_callback_t)(uint32_t, uint8_t);
typedef void (*mp_dgn_rx_callback_t)(uint32_t, uint8_t, uint8_t *);
typedef void (*standard_dgn_rx_callback_t)(uint32_t, uint8_t, uint8_t *);
...
extern void NMEA2K_ProcessRx(void);
...
extern void NMEA2K_SetDGNTxReadyCallback(dgn_tx_ready_callback_t dgn_tx_ready_cb);
extern void NMEA2K_SetMPRawDataCallback(mp_dgn_rx_callback_t mp_raw_data_cb);
extern void NMEA2K_SetStandardDGNCallback(standard_dgn_rx_callback_t std_raw_data_cb);
extern uint8 NMEA2K_GetSourceAddr(uint8 u8CanPort);
extern uint8 NMEA2K_GetDestAddrProp(void);
...
extern bool NMEA2K_OngoingMPSession(void);
extern uint16_t NMEA2K_getFreeRunTimer(uint8 u8CanPort);
#endif
