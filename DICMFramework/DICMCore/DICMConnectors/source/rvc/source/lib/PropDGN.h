...
typedef struct
{
    ...
    bit u3Reserved5 : 5;
    bit u4GasHeaterAir : 4;    // 0=Off, 1=Purge, 2=Ignite, 3=Low, 4=Med, 5=High, 15=Ignore
    bit u4GasHeaterWater : 4;  // 0=Off, 1=Purge, 2=Ignite, 3=Low, 4=Med, 5=High, 15=Ignore
...
//------------------------------------------------------------------------------
// DGN Number   : XXXXXX (0xXXXXX)
// Description  : Structure for PROP_TM510_COMMAND
// Data Length  : 8
// Tx Rate      : <<To be Update>>
// Priority     : <<To Be update>>
//------------------------------------------------------------------------------
#define PROPDGN_DGN_61184_SIZE (150 + 2)  // DDMP2_MAX_VALUE_SIZE + 2 bytes required for addr and size
typedef struct
{
    union
    {
        ...
        {
            uint8 u8Operation;
            uint8 u8Data[PROPDGN_DGN_61184_SIZE - 1 - 2];  // Remove extra bytes
        } prop;
        uint8 u8Data[PROPDGN_DGN_61184_SIZE - 2];  // Remove extra bytes
    };
    uint8_t addr;
    uint8_t size;
} PROPDGN_zDGN_61184;
extern void PROPDGN_DGN_61184_Extract(PROPDGN_zDGN_61184 *pzDest, uint8 *pu8Src, uint8 size);
extern void PROPDGN_DGN_61184_Stuff(uint8 *pu8Dest, PROPDGN_zDGN_61184 *pzSrc);

//------------------------------------------------------------------------------
// DGN Number   : 61184 (operation 42)
// Description  : Command for for Proprietary Shape Parameters
// Data Length  : 8
// Tx Rate      : <<To be Updated>>
...
#define PROPDGN_DGN_61184_Oper0x42_SIZE 8
extern void PROPDGN_DGN_Oper42_Extract(PROPDGN_zDGN_Oper42 *pzDest, uint8 *pu8Src);
extern void PROPDGN_DGN_Oper42_Stuff(uint8 *pu8Dest, PROPDGN_zDGN_Oper42 *pzSrc);
//------------------------------------------------------------------------------
// DGN Number   : 61184 (operation 43)
// Description  : Status for for Proprietary Shape Parameters
// Data Length  : 8
// Tx Rate      : <<To be Update>>
// Priority     : <<To Be update>>
//------------------------------------------------------------------------------
#define PROPDGN_zDGN_Oper43             PROPDGN_zDGN_Oper42
#define PROPDGN_DGN_61184_Oper0x43_SIZE PROPDGN_DGN_61184_Oper0x42_SIZE
#define PROPDGN_DGN_Oper43_Extract      PROPDGN_DGN_Oper42_Extract
#define PROPDGN_DGN_Oper43_Stuff        PROPDGN_DGN_Oper42_Stuff
