...
//------------------------------------------------------------------------------
short int HALCAN_Read(unsigned char u8Port, HALCAN_zMSG *pMsg)
{
...
//------------------------------------------------------------------------------
short int HALCAN_Write(unsigned char u8Port, HALCAN_zMSG *pMsg)
{
    // Redirect to hal_can
    hal_can_msg_t can_msg;
    ...
    // Return result
    // return (can_result == HAL_E_OK)? 8:FALSE;
    return can_result;
}
...
//------------------------------------------------------------------------------
uint16 HALCAN_TxFree(uint8 u8Port)
{
