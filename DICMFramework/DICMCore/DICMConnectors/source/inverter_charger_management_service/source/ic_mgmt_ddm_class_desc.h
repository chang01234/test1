/**
 * \file        ic_mgmt_ddm_class_desc.h
 * \date        2025-12-10
 * \author      Kire Janev (kire.janev@dometic.com)
 * \brief       Header file for class descriptor functions that are used for managing inverter charger and product DDM2 instances.
 *
...
#ifndef IC_MGMT_DDM_CLASS_DESC_H_
#define IC_MGMT_DDM_CLASS_DESC_H_
...
#endif /* IC_MGMT_DDM_CLASS_DESC_H_ */
